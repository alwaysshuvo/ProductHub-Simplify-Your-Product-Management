        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                    ...
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">
                                ...
                                Duct<span  className="text-green-600 text-5xl leading-0">Hub.</span>
                           
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to ProductHub, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © ProductHub All Right Reserved.
                </p>
            </div>
        </footer>
    );
